...
class OrderBookManager:
    ...
    def __init__(self):
        self.quote_no = 2
        self.quote_no_lock = threading.Lock()
        ...
        self.buy_thread = threading.Thread(
            name = "buy_thread",
    ...
    def get_snapshot(self):
        with self.quote_no_lock:
            buy_arr = self.buy_orders.tolist()
            sell_arr = self.sell_orders.tolist()
            return {"quote_no": self.quote_no, "buys": buy_arr, "sells": sell_arr}
